#ifndef __MOOD_SYSTEM_V1_H
#define __MOOD_SYSTEM_V1_H
...
struct EMO_Info{
    ...
    uint8_t static_select;       //静态表情组选择器(0~EMO_STATIC_MAX-1)
    uint8_t dynamics_count;      //动态表情计数器
    uint8_t dynamics_select;     //动态表情组选择器(0~EMO_DYNAMICS_MAX-1)
